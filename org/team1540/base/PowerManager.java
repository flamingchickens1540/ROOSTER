...
public class PowerManager extends Thread {
	...
	*/
	...
	/**
	 * Kill switch. Make it false to kill the power manager. No idea why you'd ever need to do this though
	 */
	...
	/**
	 * Determines if the voltage is currently spiking.
	 * Literally just return pdp.getTotalCurrent() > SPIKE_PEAK
	...
	/**
	 * Run an arbitrary function to scale the priority of a given subsystem.
	 *
	 * Currently uses inverse natural exponential
	 * For those who like LaTeX, here's the function, where h is the highest priority and x is the priority
	 * \frac{h}{e^{\left(h-x\right)}}
